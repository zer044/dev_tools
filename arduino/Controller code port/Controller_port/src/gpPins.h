...
#include <Arduino.h>
    ...
    // connections to the camera and the lights
    #define PIN_ERROR_LED 9							// output PIN for the red error LED, Controllino Pin D5
    #define PIN_LIGHTING_PNP 4					// output PIN to be connect to the lights STROBE_IN, Controllino Pin D6
    #define PIN_CAMERA_TRIGGER_IN A3			// output PIN to be connected to the camera's TRIGGER_IN(+) PIN, Controllino Pin D7
